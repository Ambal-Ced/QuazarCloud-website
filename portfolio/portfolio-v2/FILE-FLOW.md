...
- **What it does:**
  - Defines the page (`<html>`, `<body>`, `<title>Arzen — Portfolio</title>`).
...
| `src/components/Sidebar.tsx` | App.tsx | Left panel: “Arzen.” + nav links (Home, About, …). Uses class `app-sidebar` so it’s visible. |
